...
def classify(diag: dict, thresholds: ClassThresholds = None, persistence_s: float = None) -> dict:
    ...
    tlv = (g("v_theta_max_m_s") >= th.tlv_vtheta_m_s) or \
          (g("circulation_m2_s") >= th.tlv_circulation_m2_s and g("pressure_deficit_Pa", 0.0) <= th.tlv_pdeficit_Pa)
...
def classify_simulation(sim, z_surface_m=150.0, storm_motion=(0.0, 0.0),
                        thresholds: ClassThresholds = None, persistence_s: float = None) -> dict:
